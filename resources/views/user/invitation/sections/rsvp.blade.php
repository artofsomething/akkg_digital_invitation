    ...
    <div class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="content[subtitle]"
                   value="{{ $section->content['subtitle'] ?? 'Please confirm your attendance' }}"
                   class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300">
        </div>
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">RSVP Deadline</label>
            <input type="date" name="content[deadline]"
